...
CREATE TRIGGER set_artists_updated_at BEFORE
UPDATE ON artists FOR EACH ROW
EXECUTE FUNCTION set_updated_at ();

CREATE TRIGGER set_genres_updated_at BEFORE
UPDATE ON genres FOR EACH ROW
EXECUTE FUNCTION set_updated_at ();
...
CREATE TRIGGER set_tracks_updated_at BEFORE
